...
public sealed class RomHackInstaller
{
        ...
        Action<string>? progress = null)
    {
        ...
        var patch = PackStore.FindPatchFile(patchOrZip)
                    ?? throw new InvalidOperationException(
                        "Geen .bps/.ips/.ups-patch gevonden. VisualSSH downloadt alleen de patch, nooit een volledige ROM.");
    ...
    public static string MissingDumpMessage(PackHit hit, string romFolder)
    {
        ...
        return
            ...
            Environment.NewLine + "VisualSSH levert geen auteursrechtelijk beschermde ROMs." +
