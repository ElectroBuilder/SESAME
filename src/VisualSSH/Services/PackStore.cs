...
public sealed class PackStore
{
    ...
    public const string LegalHackNl =
        "ROM-hacks zijn community-patches, geen vervangende ROMs. U moet zelf een legale dump van een originele cartridge verzorgen. VisualSSH levert geen auteursrechtelijk beschermde ROMs. De patch is fanwerk en bevat geen Nintendo-code.";
